...
class DCAE_DDPG:
    def __init__(self, image_size, hidden_dim, observation_space, action_space, gamma=0.99, lr=1e-3, batch_size=32, memory_size=50000) -> None:
        self.dcae = DCAE(image_size=image_size, hidden_dim=hidden_dim)
